...
public class QuestionService {
    ...
    public GetQuestionDetailsResponseDto getQuestion(Long id) throws NoSuchElementException {
        ...
        QuestionDifficultyRateService.QuestionRateCounts record = questionDifficultyRateService.getResult();
        long easyCount = record.easyCount();
        long mediumCount = record.mediumCount();
        long hardCount = record.hardCount();
        DifficultyLevel lastRatedDifficulty = questionDifficultyRateService.getQuestionDifficultyRate(questionOptional.get(), currentUser).map(QuestionDifficultyRate::getDifficulty).orElse(null);
