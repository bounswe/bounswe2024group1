  ...
  ((_a = class extends Subscribable {
    ...
    onUnsubscribe() {
      ...
      if (!this.hasListeners()) {
        (_a12 = __privateGet(this, _cleanup)) == null
          ? void 0
          : _a12.call(this);
    ...
    isFocused() {
      ...
      return (
        ((_a12 = globalThis.document) == null
          ? void 0
          : _a12.visibilityState) !== "hidden"
      );
    }
  }),
...
var OnlineManager =
  ((_a2 = class extends Subscribable {
    ...
    onUnsubscribe() {
      var _a12;
      if (!this.hasListeners()) {
        (_a12 = __privateGet(this, _cleanup2)) == null
          ? void 0
          : _a12.call(this);
  ...
  const run = () => {
    ...
    Promise.resolve(promiseOrValue)
      ...
      .catch((error) => {
        ...
        failureCount++;
        (_a12 = config.onFail) == null
          ? void 0
          : _a12.call(config, failureCount, error);
        sleep(delay)
          .then(() => {
  ...
  ((_a4 = class extends Removable {
    constructor(config) {
      ...
      __privateSet(
        this,
        _initialState,
        config.state || getDefaultState(this.options),
      );
    ...
    cancel(options) {
      var _a12, _b;
      const promise =
        (_a12 = __privateGet(this, _retryer)) == null ? void 0 : _a12.promise;
    ...
    fetch(options, fetchOptions) {
      ...
      (_a12 = this.options.behavior) == null
        ? void 0
        : _a12.onFetch(context, this);
...
var Mutation =
  ((_a6 = class extends Removable {
    ...
    continue() {
      var _a12;
      return (
        ((_a12 = __privateGet(this, _retryer2)) == null
          ? void 0
          : _a12.continue()) ?? // continuing a mutation assumes that variables are set, mutation must have been dehydrated before
    ...
    async execute(variables) {
      ...
      try {
        if (!restored) {
          ...
          await ((_b = (_a12 = __privateGet(this, _mutationCache).config)
            .onMutate) == null
            ? void 0
        ...
        await ((_f = (_e = __privateGet(this, _mutationCache).config)
          .onSuccess) == null
          ? void 0
        ...
        await ((_j = (_i = __privateGet(this, _mutationCache).config)
          .onSettled) == null
          ? void 0
          : _j.call(
              _i,
  ...
  ((_a7 = class extends Subscribable {
    ...
    remove(mutation) {
      ...
      if (__privateGet(this, _mutations).has(scope)) {
        const mutations =
          (_a12 = __privateGet(this, _mutations).get(scope)) == null
            ? void 0
            : _a12.filter((x) => x !== mutation);
        if (mutations) {
    ...
    canRun(mutation) {
      ...
      const firstPendingMutation =
        (_a12 = __privateGet(this, _mutations).get(scopeFor(mutation))) == null
          ? void 0
          : _a12.find((m) => m.state.status === "pending");
...
function scopeFor(mutation) {
  var _a12;
  return (
    ((_a12 = mutation.options.scope) == null ? void 0 : _a12.id) ??
  ...
  return {
    onFetch: (context, query) => {
      const fetchFn = async () => {
        ...
        const direction =
          (_c =
            (_b = (_a12 = context.fetchOptions) == null ? void 0 : _a12.meta) ==
            null
              ? void 0
              : _b.fetchMore) == null
            ? void 0
      ...
      if (context.options.persister) {
        context.fetchFn = () => {
          var _a12, _b;
          return (_b = (_a12 = context.options).persister) == null
            ? void 0
            : _b.call(
                _a12,
                fetchFn,
...
function getPreviousPageParam(options, { pages, pageParams }) {
  var _a12;
  return (_a12 = options.getPreviousPageParam) == null
    ? void 0
...
var QueryClient =
  ((_a8 = class {
    ...
    unmount() {
      ...
      (_a12 = __privateGet(this, _unsubscribeFocus)) == null
        ? void 0
        : _a12.call(this);
    ...
    getQueryData(queryKey) {
      ...
      return (_a12 = __privateGet(this, _queryCache).get(options.queryHash)) ==
        null
        ? void 0
        : _a12.state.data;
    }
...
var QueryObserver =
  ((_a9 = class extends Subscribable {
    ...
    fetchOptimistic(options) {
      const defaultedOptions = __privateGet(this, _client).defaultQueryOptions(
        options,
      );
      const query = __privateGet(this, _client)
        .getQueryCache()
...
var QueriesObserver =
  ((_a10 = class extends Subscribable {
    ...
    setQueries(queries, _options, notifyOptions) {
      ...
      notifyManager.batch(() => {
        ...
        __privateMethod(this, _QueriesObserver_instances, notify_fn2).call(
          this,
        );
      });
    }
  ...
  (findMatchingObservers_fn = function (queries) {
    ...
    const defaultedQueryOptions = queries.map((options) =>
      __privateGet(this, _client2).defaultQueryOptions(options),
    );
    const matchingObservers = defaultedQueryOptions.flatMap(
      (defaultedOptions) => {
    ...
    const getObserver = (options) => {
      ...
      return (
        currentObserver ??
        new QueryObserver(__privateGet(this, _client2), defaultedOptions)
      );
    };
    ...
    const sortMatchesByOrderOfQueries = (a, b) =>
...
var MutationObserver =
  ((_a11 = class extends Subscribable {
    ...
    setOptions(options) {
      var _a12;
      const prevOptions = this.options;
      this.options = __privateGet(this, _client3).defaultMutationOptions(
        options,
      );
      if (!shallowEqualObjects(this.options, prevOptions)) {
        __privateGet(this, _client3)
          .getMutationCache()
          .notify({
            type: "observerOptionsUpdated",
      ...
      if (
        ...
        ((_a12 = __privateGet(this, _currentMutation)) == null
          ? void 0
          : _a12.state.status) === "pending"
      ) {
    ...
    onMutationUpdate(action) {
      ...
      __privateMethod(this, _MutationObserver_instances, notify_fn3).call(
        this,
        action,
      );
    }
    ...
    mutate(variables, options) {
      ...
      __privateSet(
        ...
        __privateGet(this, _client3)
          .getMutationCache()
          .build(__privateGet(this, _client3), this.options),
      );
