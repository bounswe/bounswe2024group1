...
export const Home = () => {
  ...
  return (
    <SafeAreaView className="w-screen bg-white  pt-6 pl-6 pr-6 h-full box-border">
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.filterOptions}>
              <FilterOption
                label="Turkey"
                selected={selectedCuisines.includes("Turkey")}
                onPress={() => toggleCuisine("Turkey")}
              />
              <FilterOption
                label="Mediterranean"
                selected={selectedCuisines.includes("Mediterranean")}
                onPress={() => toggleCuisine("Mediterranean")}
              />
              <FilterOption
                label="Chinese"
                selected={selectedCuisines.includes("Chinese")}
                onPress={() => toggleCuisine("Chinese")}
              />
              <FilterOption
                label="Japanese"
                selected={selectedCuisines.includes("Turkish")}
                onPress={() => toggleCuisine("Turkish")}
              />
              <FilterOption
                label="Italian"
                selected={selectedCuisines.includes("Italian")}
                onPress={() => toggleCuisine("Italian")}
              />
              <FilterOption
                label="French"
                selected={selectedCuisines.includes("French")}
                onPress={() => toggleCuisine("French")}
              />
            </View>
            ...
            <View style={styles.filterOptions}>
              <FilterOption
                label="Meat"
                selected={selectedFoodTypes.includes("Meat")}
                onPress={() => toggleFoodType("Meat")}
              />
              <FilterOption
                label="Vegetarian"
                selected={selectedFoodTypes.includes("Vegetarian")}
                onPress={() => toggleFoodType("Vegetarian")}
              />
              <FilterOption
                label="Baked"
                selected={selectedFoodTypes.includes("Baked")}
                onPress={() => toggleFoodType("Baked")}
              />
              <FilterOption
                label="Dairy"
                selected={selectedFoodTypes.includes("Dairy")}
                onPress={() => toggleFoodType("Dairy")}
              />
              <FilterOption
                label="Eggs"
                selected={selectedFoodTypes.includes("Eggs")}
                onPress={() => toggleFoodType("Eggs")}
              />
              <FilterOption
                label="Vegan"
                selected={selectedFoodTypes.includes("Vegan")}
                onPress={() => toggleFoodType("Vegan")}
              />
            </View>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text
            style={[
              styles.tabText,
              selectedTab === "Explore" && styles.activeTabText,
            ]}
          >
            Trending
          </Text>
      ...
      {selectedTab == "Explore" ? <Trending data={feedData} /> : <Following />}
