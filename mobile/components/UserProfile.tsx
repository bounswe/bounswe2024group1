...
import { ChevronDownIcon, Plus, Bookmark, MenuIcon, LogOutIcon, ArrowLeftIcon } from "lucide-react-native";
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1, padding: 8 }}>
      <VStack space="md" className="px-6">
        <HStack className="items-center justify-between mt-9">
          ...
          {me ? "My Profile" : profile.username +  "'s Profile" }
          </Text>
        ...
        <VStack space="xs">
            ...
            <>
              ...
              <ScrollView horizontal={true}>
                {profile.followedTags?.map((tag) => (
                  ...
                  <Badge variant="outline" size="lg" className="bg-neutral-100 my-2 mr-1">
          ...
          {me ? (
            ...
            profile && <FollowUserButton profile={{id: Number(userId), selfFollowing: profile.selfFollowing}} />
          )}
        </VStack>
        {
        <HStack space="md">
